...
export function AdminHeader() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-40 h-16 border-b border-default bg-nav-bg backdrop-blur-xl transition-all duration-300">
      <div
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-lg border border-default bg-elevated px-3 py-1.5">
